    ...
    def enter(n):
        ...
        try:
            ...
            if book.xs(j)["Avalibility"] == "available":
                ...
                tempissu = pd.DataFrame(
                    {
                        "Student ID": student.xs(n)["Student ID"],
                        "Student Name": student.xs(n)["Student Name"],
                        "Book ID": d.get(),
                        "Day of issu": datee,
                    },
                    index=[0],
    ...
    def enter1():
        ...
        try:
            ...
            messagebox.showerror(
                "Not Registerd", "student not registerd in data base can't issue book"
            )
            d.delete(0, len(d.get()))
...
def checkbook():
    ...
    f3.pack(expand=True, fill=BOTH)
    idl = Label(
        f2, text="Book ID", justify=LEFT, bg="#CCFFFF", font=("FrankRuehl", 20, "bold")
    ).grid(column=0, row=0)
    d = Entry(f2, width=10)
    ...
    def enter():
        ...
        try:
            ...
            a = messagebox.askquestion(
                "Aleart", f"Are you sure you want to delete following data:->\n{m}"
            )
            if a == "yes":
...
def addbook():
    ...
    al = Label(
        f2, text="Author", justify=LEFT, bg="#CCFFFF", font=("FrankRuehl", 20, "bold")
    ).grid(column=0, row=2)
    a = Entry(f2, width=20)
    a.grid(column=1, row=2)
    el = Label(
        f2, text="Edition", justify=LEFT, bg="#CCFFFF", font=("FrankRuehl", 20, "bold")
    ).grid(column=0, row=3)
    e = Entry(f2, width=20)
...
def listbooks():
    ...
    lal = Label(
        root2, text=book, justify=LEFT, bg="#CCFFFF", font=("FrankRuehl", 15)
